    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        <TouchableOpacity style={styles.backButton} onPress={() => navigation.goBack()}>
          ...
          <Text style={styles.backButtonText}>Privacy Policy</Text>
        </TouchableOpacity>
      </View>
