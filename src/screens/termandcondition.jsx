...
onPress={() => {Alert.alert(`clicked Thanks ${Url}`)}}>
{childern}
</Text>
);
...
{'\n'}
{'\n'}c) Use of Credits. Depending on the subscription plan you choose and purchase, you will be allotted credits to be used solely to book Classes each Subscription Cycle. You can choose how you use your credits across the various Classes available to you.
{'\n'}
...
{'\n'}
{'\n'}Credits have no cash value or any other value outside of the BrackettUp platform and are not redeemable for cash. For avoidance of doubt, the credits do not operate or serve as stored value facilities in any way. You may not transfer, trade, gift or otherwise exchange BrackettUp credits. Note that separate from credits, you can also buy a gift certificate. Gift certificates and credits are not the same thing. Our gift certificates are called “gift cards“. Unlike credits, gift cards never expire. Gift cards are discussed further in Section 4(b) below.
{'\n'}
{'\n'}d) Class Availability and Allocation. The exact number and type of Classes you take during any Subscription Cycle will depend on the number of credits needed to book the particular Classes you select. The number of credits needed to book a particular Class will vary and is determined based on a variety of factors, including but not limited to Venue requirements, time of day, equipment, facilities, the number of times you’ve visited a studio in the cycle, location, pricing, popularity and other characteristics. For example, a Class offered at a peak time is likely to require more credits to book than the same Class offered in the middle of the afternoon. Or, a Class that uses equipment is likely to require more credits to book than a Class without the use of any equipment. Furthermore, a Venue may require more credits for a certain Class under certain circumstances, such as when the Venue makes only a small number of spots available to BrackettUp or after multiple visits in a cycle. Note that credits needed to book Classes also vary from city to city. Accordingly, if BrackettUp permits you to reserve Classes in a city that differs from your home location, your credits may enable you to reserve more or fewer Classes when you are traveling from your home location. As such, the number of credits you need to reserve a particular Class or service may change at any time or vary day to day depending on the factors described here. BrackettUp also reserves the right to change the number of credits you receive, including per cycle, plan, geography or otherwise; the number of reservations you can make; and/or the number of Classes you can miss or cancel.
{'\n'}
{'\n'}BrackettUp does not guarantee the availability of particular Venues, locations, Classes, services, experiences, content, inventory, spots or other features, and availability may change over time and at any time (including during the course of any given Subscription Cycle). The type, quantity, credits, allocation and availability of Venues, Classes, and other inventory offered, are determined by BrackettUp in its sole discretion. BrackettUp takes certain steps to release, promote and otherwise make available spots and inventory at varying times and in an ongoing and evolving way.
{'\n'}
{'\n'}e) Digital Classes. BrackettUp may allow you to access a variety of audio or video digital Classes from your computer or mobile device, via live stream and/or on demand. To access these digital Classes, you need to comply with certain technical and hardware requirements. Certain digital classes may involve your participation through connected devices such as heart rate monitors. If you participate in such digital Classes through a connected device, we may collect heart rate and other metrics (e.g., points) to calculate your ranking in a Class leaderboard (if you sync your heart rate monitor to the Site), display a record of your participation, and otherwise provide, learn about and improve the Site and our services. If you sync your heart rate monitor with the Site to participate in digital Classes, you will automatically be part of the leaderboard experience, and other participants in the Class will see your profile information (including your profile picture and username) and rank in the class. Additionally, your profile information may appear on our Site and be viewable by other BrackettUp users. For example, BrackettUp may show a weekly leaderboard displaying the profiles of the ten users who have the highest cumulative point totals for the week. If you do not want your profile picture or username to be seen by other BrackettUp users, don’t include any identifying information in your profile, or go to your settings to change it. BrackettUp is not responsible for the accuracy of the heart rate monitor used in connection with the digital Classes. The heart rate recommendations and goals provided through these digital Classes may not be right for you and it is solely your responsibility to make sure that you participate in the manner and at the intensity level that is right for you.
{'\n'}
{'\n'}f) Non-Subscription Purchases. BrackettUp may permit you to purchase certain products or Classes through the Site, in addition to your subscription or without having a subscription. You acknowledge and agree that these Terms apply to any such purchase you make, and you will be responsible to pay the applicable fees, which may change at any time.
{'\n'}
{'\n'}g) Co-Memberships. From time to time BrackettUp may permit you to sign up for a co-membership that provides you with a membership to BrackettUp as well as a membership to a third-party Venue, such as a gym (“Venue Membership”). If you sign up for a co-membership, you will be subject to these Terms as well as additional terms applicable to the co-membership and the Venue Membership. You understand and agree that BrackettUp does not own, operate or control the Venue Membership and is not responsible for the Venue Membership, which is provided entirely by the applicable Venue and subject to the Venue's terms and conditions of membership.
{'\n'}
{'\n'}h) Use of BrackettUp. Your BrackettUp account is personal to you and you agree not to create more than one account. You cannot transfer or gift Classes or credits to third parties or allow third parties to use your BrackettUp account, including other BrackettUp users. You must not use or exploit the Site and/or Classes for commercial purposes. To use your BrackettUp membership you must have access to the Internet. We continually update and test various aspects of the BrackettUp platform. We reserve the right to, and by using the Site and/or Classes you agree that we may, include you in or exclude you from these test without notice. You understand and agree that BrackettUp may take actions we deem reasonably necessary to prevent fraud and abuse.
{'\n'}
{'\n'}You agree that the information you provide to BrackettUp at sign up and at all other times will be true, accurate, current, and complete and that you will keep this information accurate and up-to-date at all times. When you sign up, you will be asked to create a password. You are solely responsible for all activity that occurs under your account, including any activity by unauthorized users. To use the Site you must have access to the Internet and may be required to download a BrackettUp mobile application to use some or all of BrackettUp features. You are solely responsible for providing your own access (e.g., computer, mobile device, Internet connection, etc.) to the Site and Classes.
{'\n'}
{'\n'}i) Eligibility Criteria. The availability of all or part of our Site and/or Classes may be limited based on demographic, age, or other criteria as we may establish from time to time. You understand and agree we may disallow you from subscribing to BrackettUp or may terminate your subscription at any time based on these criteria. For example, you must be 18 years of age or older to use this Site and/or Classes and/or to purchase a BrackettUp subscription. You further understand that the Site and/or Classes may not be available in every geography.
{'\n'}
...
{'\n'}
{'\n'}ACCESS TO OUR SITE IS NOT PERMITTED FROM OTHER JURISDICTIONS. THESE TERMS ARE ONLY APPLICABLE TO USERS IN THE INDIAN ECONOMIC AREA. THE SITE IS NOT AVAILABLE TO ANY USERS SUSPENDED OR REMOVED FROM THE SITE BY CLASSPASS. BY USING THE SITE, YOU REPRESENT THAT YOU ARE RESIDENT OF THE INDIAN ECONOMIC AREA, AT LEAST 18 YEARS OLD AND HAVE NOT BEEN PREVIOUSLY SUSPENDED OR REMOVED. THOSE WHO CHOOSE TO ACCESS THE SITE DO SO AT THEIR OWN INITIATIVE AND ARE RESPONSIBLE FOR COMPLIANCE WITH ALL LOCAL RULES INCLUDING, WITHOUT LIMITATION, RULES ABOUT THE INTERNET, DATA, EMAIL OR OTHER ELECTRONIC MESSAGES, OR PRIVACY.
{'\n'}
{'\n'}j) Subscribing Organizations.If you are using or opening an account on behalf of a company, entity, or organization (a “Subscribing Organization”), then you represent and warrant that you are an authorized representative of that Subscribing Organization with the authority to bind such organization to these Terms; and agree to be bound by these Terms on behalf of such Subscribing Organization.
...
{'\n'}
{'\n'}f) Cancellation. Unless we communicate otherwise, and in addition to your right to cancel within 14 days of initial purchase as set out below, you may terminate your subscription at any time before your subscription renews, by going into your account settings on the BrackettUp website and letting us know you would like to cancel. Unless we communicate otherwise, and except for during a Trial, following any cancellation you will continue to have access to your subscription through the end of your current prepaid Subscription Cycle, unless you cancel and receive a refund, in which case your access will be terminated immediately. Note that if you do terminate your subscription, we reserve the right to charge a reactivation fee if you want to return to BrackettUp in future months or to restrict your access in future months.
{'\n'}
{'\n'}g) Other Fees. You are responsible for paying applicable fees if you do not cancel a Class with appropriate notice or do not attend your scheduled Class. Click here for our current cancellation and missed Class rules, including the applicable fees. We reserve the right to change the policy regarding when we charge fees, to introduce additional fees (such as a sign-up fee) and to change the amount of any such fees at any time.
{'\n'}
{'\n'}h) Reservation and Cancellation of Classes. As a BrackettUp user you must reserve and cancel your BrackettUp Classes only through the Site. Click here for our current cancellation and missed Class policy. It is a breach of these Terms if you reserve or cancel a service directly with a Venue, including through any online or mobile account you have with a Venue, independent of BrackettUp. If you reserve or cancel directly with such Venue, we reserve the right to charge you the full amount that the Venue charges for such class and/or any applicable cancellation fees, and/or to terminate your subscription.
{'\n'}
...
{'\n'}
{'\n'}Contact us here. Or by postal mail at 101 E. Front Street, Suite 202, Missoula, MT 59802, Attention: BrackettUp Customer Support – Cancellation Notice.
{'\n'}
...
{'\n'}j) Fees Charged by Venues. In addition to fees we charge, Venues may also charge equipment or other amenity fees that you will be responsible for directly. For example, some Venues might charge extra to rent a yoga mat or cycling shoes. Further, BrackettUp only gives you access to the Class for which you signed up on the Site (and at the specified time and location). The Venue may have additional fees for use of additional classes or spaces.
{'\n'}
{'\n'}k) Third Party Fees for Using BrackettUp. You are also responsible for all third-party charges and fees associated with connecting to and using the Site and/or Classes, including fees such as internet service provider fees, telephone and computer equipment charges, and any other fees necessary to access the Site and/or Classes.
...
{'\n'}You agree that BrackettUp may, in its sole discretion and at any time (i) terminate, cancel, deactivate, disable, delete and/or suspend any account, subscription, any orders placed, your access to or use of the Site, your membership and/or Classes (or any part thereof including but not limited to your access to any or all Venues, credits or Classes or services) you may have with BrackettUp and remove and discard all or any part of your account or any content uploaded by you and/or (ii) discontinue, disable, suspend, modify or alter any aspect, feature or policy of the Site including of your subscription in the event that you are in breach of these Terms or otherwise.
{'\n'}
{'\n'}BrackettUp may also in its sole discretion and at any time discontinue providing access to the Site, or any part thereof, without reason or notice to you. We further reserve the right to terminate your access to the Site or any account you may have or portion thereof without prior notice. This includes the right to terminate or modify any subscription prior to the end of any pre-paid or committed period.
{'\n'}
{'\n'}Upon any termination or cancellation of your subscription by BrackettUp, we may immediately deactivate your account and all related information and/or bar any further access to your account information and the Site and you shall have no recourse for, any such termination or deactivation.
{'\n'}
{'\n'}If you are a subscriber and we have terminated or cancelled your subscription or access to the Site, without cause then upon any such termination by us we will issue you a pro rata refund of the prepaid portion of your subscription applicable to future unused services (less any fees or costs for Classes or services already used). If we determine that you have violated these Terms or otherwise engaged in illegal or improper use of your membership, Classes and/or the Site, you will not be entitled to any refund and you agree that we will not be responsible to pay any such refund. You agree that BrackettUp will not be liable to you or any third party for any such termination.
{'\n'}
{'\n'}In the event that we amend any of these Terms (or Additional Terms) and you do not accept such amendment or we are modifying or discontinuing the services and you no longer wish to continue with your subscription for that reason, you acknowledge that your only right with respect to any amendment or dissatisfaction with any modification or discontinuation of service made by us is to cancel or terminate your subscription. If BrackettUp deletes your account for these reasons, you may not re-register for or use the Site and/or Classes under any other user name, email, payment method or profile. BrackettUp may block your access to the Site to prevent re-registration.
...
{'\n'}Your privacy is important to BrackettUp. The BrackettUp Privacy Policy is hereby incorporated into these Terms by reference. Please read the privacy policy carefully for information relating to BrackettUp’s collection, use, and disclosure of your personal information.
...
{'\n'}{'\n'}Harass, threaten, stalk, disrupt or defraud users, members or staff of BrackettUp or Venues or any other person, or otherwise create or contribute to an unsafe, harassing, threatening or disruptive environment;
{'\n'}
...
{'\n'}
{'\n'}Share BrackettUp passwords with any third party or encourage any other user to do so;
{'\n'}
...
{'\n'}
{'\n'}Upload material (e.g. virus) that is damaging to computer systems or data of BrackettUp or users of the Site or otherwise use the Site in any manner that could damage, disable, overburden, or impair it or interfere with any other party’s use and enjoyment of the Site;
{'\n'}
...
{'\n'}
{'\n'}BrackettUp reserves the right to refuse service, terminate accounts, remove or edit content, or cancel orders in its sole discretion.
...
{'\n'}The BrackettUp website and mobile applications are owned and operated by the BrackettUp group of companies. The content, recordings, visual interfaces, graphics, design, compilation, information, computer code, products, software (including any downloadable software), services, and all other elements of the Site provided by BrackettUp (“Materials”) are protected by local copyright, trade dress, patent, and trademark laws, international conventions, and all other relevant intellectual property and proprietary rights, and applicable laws. Except for your User Submissions, all Materials contained on the Site are the copyrighted property of BrackettUp or its subsidiaries or affiliated companies and/or third-party licensors whether registered or unregistered and may not be used in connection with any product or service or in any manner that is likely to cause confusion as to our endorsement, affiliation or sponsorship of any person, product or service. All trademarks, service marks, and trade names used by us on the Site are proprietary to BrackettUp or its affiliates and/or third-party licensors. Except as expressly authorized by BrackettUp, you agree not to sell, license, distribute, copy, modify, publicly perform or display, transmit, publish, edit, adapt, create derivative works from, or otherwise make unauthorized use of the Materials and may only access the Materials for your personal, non-commercial use. In the event that Materials are downloaded to your computer or mobile phone, you do not obtain any ownership interest in such Materials. All rights not expressly granted in this Agreement are reserved.
...
{'\n'}The Site may include links to other web sites or services (“Linked Sites”) solely as a convenience to users. BrackettUp does not endorse any such Linked Sites or the information, material, products, or services contained on other linked sites or accessible through other Linked Sites. Furthermore, BrackettUp makes no express or implied warranties with regard to the information, material, products, or services that are contained on or accessible through linked sites. ACCESS AND USE OF LINKED SITES, INCLUDING THE INFORMATION, MATERIAL, PRODUCTS, AND SERVICES ON LINKED SITES OR AVAILABLE THROUGH LINKED SITES, IS SOLELY AT YOUR OWN RISK.
{'\n'}
...
{'\n'}Generally, if a dispute arises between BrackettUp and you, our goal is to provide you with a neutral and cost effective means of resolving the dispute quickly. Accordingly, you and BrackettUp agree that the parties will resolve any claim or controversy at law or equity that arises out of this Agreement or the Site (a “Claim”) in accordance with one of the subsections below or as you and we otherwise agree in writing. Before resorting to these alternatives, we strongly encourage you to first contact us directly to seek a resolution. We will consider reasonable requests to resolve the dispute through alternative dispute resolution procedures, such as mediation or arbitration, as alternatives to litigation.
...
{'\n'}
{'\n'}e) Entire Agreement. This (including the documents referred to herein), as each may be amended as set forth herein, is the entire agreement between you and BrackettUp relating to the subject matter herein.
{'\n'}
